    ...
    return (
        <div data-tauri-drag-region className="flex items-center justify-between flex-row w-full">
            ...
            <div className="flex justify-end space-x-3 pr-4">
                <button onClick={() => appWindow.minimize()} className="hover:bg-gray-200 rounded-full" id="titlebar-minimize">
                ...
                <button onClick={() => appWindow.toggleMaximize()} className="hover:bg-gray-200 rounded-full" id="titlebar-maximize">
                ...
                <button onClick={() => appWindow.close()} className="hover:bg-gray-200 rounded-full" id="titlebar-close">
